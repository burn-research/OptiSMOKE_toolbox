...
class OpenSMOKE_Flame1D_MyFalseTransientSystem_OpenSMOKEpp_Premixed_FLAMESPEED
{
public:

	OpenSMOKE_Flame1D_MyFalseTransientSystem_OpenSMOKEpp_Premixed_FLAMESPEED() {};
