...
/**
 \class EtaGVDI
 \brief Class to determine the gas components' dynamic viscosity \f$\eta_{i}^g\f$ by use of polynomial and coefficients given in VDI Waermeatlas
...
class EtaGVDI : public ViscosityModel{
