...
/**
 \class RhoYaws
 \brief Class to determine the liquid components' density \f$\rho_{i}^l\f$ by use of polynomial and coefficients given in Yaws: Chemical Properties Handbook
...
class RhoYaws : public DensityModel {
...
public:
     ...
     */
    RhoYaws(double* coefficients);
    ~RhoYaws();
    /** \brief Function to determine density \f$\rho_{i}^l\f$ at given temperature
     @param T temperature
     
     \f[
     \rho_{i}^l=\frac{a_i}{b_i^{1+\left(1+\frac{1-T}{c_i}\right)^{d_i}}}
     \f]
     */
