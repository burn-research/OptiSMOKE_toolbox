...
namespace OpenSMOKE
{
	class Grammar_SurfacePerfectlyStirredReactor_Options : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
	...
	SurfacePerfectlyStirredReactor_Options::SurfacePerfectlyStirredReactor_Options()
	{
	...
	void SurfacePerfectlyStirredReactor_Options::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary)
	{
		Grammar_SurfacePerfectlyStirredReactor_Options grammar;
