...
namespace OpenSMOKE
{
	...
	ODESystem_BzzOde_SurfaceBatchReactor* ptOde_SurfaceBatchReactor_Isothermal_ConstantPressure;
	void ODE_Print_SurfaceBatchReactor_Isothermal_ConstantPressure(BzzVector &Y, double t)
	{
		ptOde_SurfaceBatchReactor_Isothermal_ConstantPressure->MyPrint(Y,t);
	}
	#endif

	SurfaceBatchReactor_Isothermal_ConstantPressure::SurfaceBatchReactor_Isothermal_ConstantPressure(	
	...
	{
		type_ = SURFACEBATCH_REACTOR_ISOTHERMAL_CONSTANTP;
	...
	int SurfaceBatchReactor_Isothermal_ConstantPressure::Equations(const double t, const OpenSMOKE::OpenSMOKEVectorDouble& y, OpenSMOKE::OpenSMOKEVectorDouble& dy)
	{
		// Recover unknowns
		{
			unsigned int k=1;
	...
	int SurfaceBatchReactor_Isothermal_ConstantPressure::Print(const double t, const OpenSMOKE::OpenSMOKEVectorDouble& y)
	{
		iteration_++;
	...
	void SurfaceBatchReactor_Isothermal_ConstantPressure::Solve(const double tf)
	{
		if (batch_options_.verbose_output() == true)
		{
			std::cout << std::endl;
		...
		else if (ode_parameters_.type() == ODE_Parameters::ODE_INTEGRATOR_BZZODE)
		{
			...
			ptOde_SurfaceBatchReactor_Isothermal_ConstantPressure = &odebatch;
			o.StepPrint(ODE_Print_SurfaceBatchReactor_Isothermal_ConstantPressure);
	...
	void SurfaceBatchReactor_Isothermal_ConstantPressure::SensitivityAnalysis(const double t, const OpenSMOKE::OpenSMOKEVectorDouble& y)
	{
		FatalErrorMessage("SurfaceBatchReactor_Isothermal_ConstantPressure::SensitivityAnalysis not yet implemented");
