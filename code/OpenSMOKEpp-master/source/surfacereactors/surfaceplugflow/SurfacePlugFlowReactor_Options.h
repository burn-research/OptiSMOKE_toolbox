...
#ifndef OpenSMOKE_SurfacePlugFlowReactor_Options_H
#define	OpenSMOKE_SurfacePlugFlowReactor_Options_H
...
namespace OpenSMOKE
{
	class SurfacePlugFlowReactor_Options
	{
	public:
		...
		*/
		SurfacePlugFlowReactor_Options();
...
#include "SurfacePlugFlowReactor_Options.hpp"

#endif	/* OpenSMOKE_SurfacePlugFlowReactor_Options_H */
