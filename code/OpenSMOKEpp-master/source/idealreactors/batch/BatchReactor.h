	...
	*/
	...
	public:
		...
		*/	
		...
		/**
		* AB - Added this to be able to have profiles 
		*@brief Returns the current values of mole fractions [-]
		*/
		const OpenSMOKE::OpenSMOKEVectorDouble& mole_fractions() const { return x_; }
		/**
