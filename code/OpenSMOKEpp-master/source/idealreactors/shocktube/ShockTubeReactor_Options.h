...
#ifndef OpenSMOKE_ShockTubeReactor_Options_H
#define	OpenSMOKE_ShockTubeReactor_Options_H
...
namespace OpenSMOKE
{
	class ShockTubeReactor_Options
	{
	public:
...
#include "ShockTubeReactor_Options.hpp"

#endif	/* OpenSMOKE_ShockTubeReactor_Options_H */
