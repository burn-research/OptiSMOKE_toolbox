...
#ifndef OpenSMOKE_PerfectlyStirredReactor_Options_H
#define	OpenSMOKE_PerfectlyStirredReactor_Options_H
...
namespace OpenSMOKE
{
	class PerfectlyStirredReactor_Options
	{
	public:
		...
		*/
		PerfectlyStirredReactor_Options();
		...
		*@brief Returns the verbose ASCII output
		*/
		bool verbose_reactionrates_file() const			{ return verbose_reactionrates_file_; }
	...
	private:
		...
		bool verbose_reactionrates_file_;						//!< verbose ReactionR file
...
#include "PerfectlyStirredReactor_Options.hpp"

#endif	/* OpenSMOKE_PerfectlyStirredReactor_Options_H */
