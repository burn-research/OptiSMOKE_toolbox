...
namespace OpenSMOKE
{
	...
	bool ReactionPolicy_CHEMKIN::ReadReactionFromStrings(const std::vector<std::string>& lines, const std::map<std::string, unsigned int>& map_of_species)
	{
			...
			// does a quick check on the first reaction to see if the values are 3 and they can be converted to <double> or not
			...
			// Next lines //ciao
			{
				...
				{
					// Analyse line by line looking into the for loop!
					std::string line = lines[l];
					std::string keyword;
					// Get the keyword which is before the sign: "/", this happens for LOW/HIGH in troe reactions, and PLOG/PLOGMX/PLOGSP and others, or third body species!!!!
					OpenSMOKE_Utilities::LookForKeyWord(line, keyword);
					// get the iterator to the element in the map
					std::map<std::string, unsigned int>::const_iterator it=map_of_species.find(keyword);
					
					// takes all the efficiencies for third body species! Then it checks if it's not the last element because the last element is returned by find if it is not capable of finding the element in the map!!!
					if( it != map_of_species.end())
					{
					...
					} // In the following, if the line is not a line containing third body efficiencies, then 
					else
					{
						if (boost::iequals(keyword, "CHEB"))
						{
							...
							if (iLow_ == true || iHigh_ == true || troe_.size()!=0 || sri_.size()!=0 || iFit1_ == true || iJan_ == true || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "FIT1"))
						{
							...
							if (iChebyshev_ == true || chebyshev_pressure_limits_.size()!=0 || chebyshev_temperature_limits_.size()!=0 || iJan_ == true || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "HIGH"))
						{
							...
							if (iLow_ == true || iChebyshev_ == true || chebyshev_pressure_limits_.size()!=0 || chebyshev_temperature_limits_.size()!=0 ||
								iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "JAN"))
						{
							...
							if (iChebyshev_ == true || chebyshev_pressure_limits_.size()!=0 || chebyshev_temperature_limits_.size()!=0 || iFit1_ == true || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "LOWMX"))
						{
							...
							if (iLow_ == true || iHigh_ == true || iChebyshev_ == true || chebyshev_pressure_limits_.size() != 0 || chebyshev_temperature_limits_.size() != 0 || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true)
							{
						...
						else if (boost::iequals(keyword, "LT"))
						{
							...
							if (iChebyshev_ == true || chebyshev_pressure_limits_.size()!=0 || chebyshev_temperature_limits_.size()!=0 || iFit1_ == true || iJan_ == true ||
								iLow_ == true || iHigh_ == true || iTroe_ == true || iSRI_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "PLOG"))
						{
							...
							if (iLow_ == true || iHigh_ == true || troe_.size()!=0 || sri_.size()!=0 || iFit1_ == true || iJan_ == true || iLandauTeller_ == true ||
								iChebyshev_ == true || chebyshev_pressure_limits_.size() != 0 || chebyshev_temperature_limits_.size() != 0 || iExtPlog_ == true || iExtPlogOpt_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "PLOGMXTB"))
						{
							if (iThirdBody_ == true)
							{
								std::cout << "The PLOGMXTB option cannot be used for third-body reactions!" << std::endl;
								return false;
							}
							if (iLow_ == true || iHigh_ == true || troe_.size() != 0 || sri_.size() != 0 || iFit1_ == true || iJan_ == true || iLandauTeller_ == true ||
								iChebyshev_ == true || chebyshev_pressure_limits_.size() != 0 || chebyshev_temperature_limits_.size() != 0 || iPlog_ == true || iExtLow_ == true)
							...
							iExtPlogOpt_ = true;
							std::vector<std::string> coefficients;
							bool tag = OpenSMOKE_Utilities::ReadReactionKeyWordPlusWords("Extended Pressure Dependence through Logarithmic Interpolation Rate Expressions including third bodies (PLOGMX). ", line, 5, coefficients);
							if (tag == false) return false;
							
							// Mixture (same structure for specific species)
							extendedplogopt_coefficients_.push_back("Mixture");
							extendedplogopt_coefficients_.push_back("-1");
							...
							for (unsigned int i = 0; i < coefficients.size(); i++)
							{
								...
								{
									std::cout << "PLOGMXTB: The coefficients are not written properly (they are not numbers)" << std::endl;
									return false;
								}

								extendedplogopt_coefficients_.push_back(coefficients[i]);
							}
						}
						else if (boost::iequals(keyword, "PLOGSPTB"))
						{
							if (iThirdBody_ == true)
							{
								std::cout << "The PLOGSPTB option cannot be used for third-body reactions!" << std::endl;
								return false;
							}
							if (iLow_ == true || iHigh_ == true || troe_.size() != 0 || sri_.size() != 0 || iFit1_ == true || iJan_ == true || iLandauTeller_ == true ||
								iChebyshev_ == true || chebyshev_pressure_limits_.size() != 0 || chebyshev_temperature_limits_.size() != 0 || iPlog_ == true || iExtLow_ == true)
							...
							iExtPlogOpt_ = true;
							std::vector<std::string> coefficients;
							bool tag = OpenSMOKE_Utilities::ReadReactionKeyWordPlusWords("Extended Pressure Dependence through Logarithmic Interpolation Rate Expressions including third bodies (PLOGSP). ", line, 6, coefficients);
							if (tag == false) return false;
							...
							// Bath species
							{
								...
								if (it == map_of_species.end())
								{
									std::cout << "PLOGSPTB: The following bath species is not available: " << coefficients[0] << std::endl;
									return false;
								}

								extendedplogopt_coefficients_.push_back(coefficients[0]);
								extendedplogopt_coefficients_.push_back(boost::lexical_cast<std::string>((*it).second));
							}
							...
							for (unsigned int i = 1; i < coefficients.size(); i++)
							{
								...
								{
									std::cout << "PLOGSPTB: The coefficients are not written properly (they are not numbers)" << std::endl;
									return false;
								}
						...
						else if (boost::iequals(keyword, "SRI"))
						{
							...
							if (troe_.size()!=0 || iChebyshev_ == true || chebyshev_pressure_limits_.size()!=0 || chebyshev_temperature_limits_.size()!=0 || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
						...
						else if (boost::iequals(keyword, "SRISP"))
						{
							...
							if (iLow_ == true || iHigh_ == true || troe_.size() != 0 || sri_.size() != 0 || iChebyshev_ == true || chebyshev_pressure_limits_.size() != 0 || chebyshev_temperature_limits_.size() != 0 || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true)
							{
						...
						else if (boost::iequals(keyword, "TROE"))
						{
							...
							if (sri_.size()!=0 || iChebyshev_ == true || chebyshev_pressure_limits_.size()!=0 || chebyshev_temperature_limits_.size()!=0 || iLandauTeller_ == true || iPlog_ == true || iExtPlog_ == true || iExtPlogOpt_ == true || iExtLow_ == true)
							{
	...
	void ReactionPolicy_CHEMKIN::ConvertUnits() 
	{
		...
		else // simple or third-body
		{
			...
			if (iExtPlogOpt_ == true)
			{
				extendedplogopt_coefficients_.push_back(boost::lexical_cast<std::string>(std::pow(1.e3, 1. - sumLambdaReactants_) / std::pow(a_conversion_, 1. - sumLambdaReactants_)));
				extendedplogopt_coefficients_.push_back(boost::lexical_cast<std::string>(e_conversion_));
			}
                ...
                std::stringstream& reaction_data, const std::vector<bool>& isReducedSpecies, const std::string& strong_comment) const
	{
				...
				Tag() != PhysicalConstants::REACTION_EXTENDEDFALLOFF )
        {
			...
			// AB //
			if (IsExtendedPressureLogOpt() == true)
			{
				// Low-pressure parameters
				OpenSMOKE::Optimization_EPLE extendedPressureLogForOptimization;
				extendedPressureLogForOptimization.Setup(extendedplog_coefficients_);
				extendedPressureLogForOptimization.WriteCHEMKINOnASCIIFile(reaction_data);
			}
			// AB //
	...
	void ReactionPolicy_CHEMKIN::WriteAdditionalDataOnASCIIFile(std::ostream& fOut) const
	{
		if (tag_reaction_ == PhysicalConstants::REACTION_SIMPLE)
		{
			...
			else if (iExtPlogOpt_ == true) // AB //
			{
				fOut << extendedplogopt_coefficients_.size() << std::endl;
				for (unsigned int j = 0; j<extendedplogopt_coefficients_.size(); j++)
					fOut << extendedplogopt_coefficients_[j] << " ";
				fOut << std::endl;
			}
			else if (iJan_ == true)
			{
	...
	void ReactionPolicy_CHEMKIN::WriteShortSummary(std::ostream& fOut, const std::vector<std::string>& list_species, const Eigen::VectorXd& reverse_parameters) const
	{
		...
		// Logarithmic-Pressure Dependence for optimization // AB //
		if (iExtPlogOpt_ == true)
		{
			// Conversion is managed internally
			OpenSMOKE::Optimization_EPLE extendedPressureLogarithmicForOptimization;
			extendedPressureLogarithmicForOptimization.Setup(extendedplogopt_coefficients_);
			extendedPressureLogarithmicForOptimization.WriteShortSummaryOnASCIIFile(fOut);
		}
	...
	void ReactionPolicy_CHEMKIN::WriteKineticsDataOnASCIIFileOldStyle(std::ofstream &fOutput) const
	{
		...
		else if (iExtPlogOpt_ == true)								ErrorMessage("WriteKineticsDataOnASCIIFileOldStyle", "PLOGMXTB and PLOGSPTB reactions are not available in the old format...");
