...
#ifndef OpenSMOKE_ReactionPolicy_Liquid_CHEMKIN_H
#define	OpenSMOKE_ReactionPolicy_Liquid_CHEMKIN_H
...
namespace OpenSMOKE
{
	...
	*/
	...
	class ReactionPolicy_Liquid_CHEMKIN 
	{
	public:
		...
		* Default constructor
		*/
		ReactionPolicy_Liquid_CHEMKIN();

		/**
		* Copy constructor
		*/
		ReactionPolicy_Liquid_CHEMKIN(const ReactionPolicy_Liquid_CHEMKIN& orig);
    
		/**
		* Default destructor
		*/
		virtual ~ReactionPolicy_Liquid_CHEMKIN();
	...
	protected:
		...
		double sumLambdaLiquidReactants_;								//!< sum of reaction orders of reactants
		double sumLambdaLiquidProducts_;								//!< sum of reaction orders of products
...
#include "ReactionPolicy_Liquid_CHEMKIN.hpp"

#endif	/* OpenSMOKE_ReactionPolicy_Liquid_CHEMKIN_H*/
