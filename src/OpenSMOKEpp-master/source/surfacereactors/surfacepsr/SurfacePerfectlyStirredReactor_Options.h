...
#ifndef OpenSMOKE_SurfacePerfectlyStirredReactor_Options_H
#define	OpenSMOKE_SurfacePerfectlyStirredReactor_Options_H
...
namespace OpenSMOKE
{
	class SurfacePerfectlyStirredReactor_Options
	{
	public:
		...
		*/
		SurfacePerfectlyStirredReactor_Options();
...
#include "SurfacePerfectlyStirredReactor_Options.hpp"

#endif	/* OpenSMOKE_SurfacePerfectlyStirredReactor_Options_H */
