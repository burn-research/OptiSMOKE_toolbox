...
#ifndef OpenSMOKE_SurfaceBatchReactor_Isothermal_ConstantPressure_H
#define	OpenSMOKE_SurfaceBatchReactor_Isothermal_ConstantPressure_H
...
namespace OpenSMOKE
{
	//!  A class for simulating batch reactors with constant pressure in isothermal conditions
	/*!
		 The purpose of this class is to simulate a batch reactor with constant pressure, in isothermal conditions
		 The conservation equations of species are solved in terms of mass fractions.
	*/

	class SurfaceBatchReactor_Isothermal_ConstantPressure : public SurfaceBatchReactor
	{
	...
	public:
		...
		*/
		SurfaceBatchReactor_Isothermal_ConstantPressure(	OpenSMOKE::ThermodynamicsMap_CHEMKIN& thermodynamicsMap, 
...
#include "SurfaceBatchReactor_Isothermal_ConstantPressure.hpp"

#endif	/* OpenSMOKE_SurfaceBatchReactor_Isothermal_ConstantPressure_H */
