...
#ifndef OpenSMOKE_SurfaceBatchReactor_Options_H
#define	OpenSMOKE_SurfaceBatchReactor_Options_H
...
namespace OpenSMOKE
{
	class SurfaceBatchReactor_Options
	{
	public:
...
#include "SurfaceBatchReactor_Options.hpp"

#endif	/* OpenSMOKE_SurfaceBatchReactor_Options_H */
