...
namespace OpenSMOKE
{
	SurfacePlugFlowReactor_Profile::SurfacePlugFlowReactor_Profile(OpenSMOKE::OpenSMOKEVectorDouble& x, OpenSMOKE::OpenSMOKEVectorDouble& y, const std::string x_variable)
	{
	...
	double SurfacePlugFlowReactor_Profile::Get(const double x) const
	{
