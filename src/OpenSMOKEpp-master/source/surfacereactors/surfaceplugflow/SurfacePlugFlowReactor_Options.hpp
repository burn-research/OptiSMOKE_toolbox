...
namespace OpenSMOKE
{
	class Grammar_SurfacePlugFlowReactor_Options : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
	...
	SurfacePlugFlowReactor_Options::SurfacePlugFlowReactor_Options()
	{
	...
	void SurfacePlugFlowReactor_Options::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary)
	{
		Grammar_SurfacePlugFlowReactor_Options grammar;
