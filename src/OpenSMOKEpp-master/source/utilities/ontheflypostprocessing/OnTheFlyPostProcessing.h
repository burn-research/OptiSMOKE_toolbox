...
namespace OpenSMOKE
{
	...
	*/
	...
	private:
		...
		std::ofstream fFormationRates_;		//!< output file for formation rates [kmol/m3/s or kg/m3/s]
		std::ofstream fReactionRates_;		//!< output file for reaction rates [kmol/m3/s]
		std::ofstream fClassGrouping_;		//!< output file for class grouping
		...
		std::vector<unsigned int> widths_of_formation_rates_species_;       //!< width   of species for which the profiles are written on the ASCII file
		...
		std::vector<unsigned int> widths_of_grouping_names_families_;
