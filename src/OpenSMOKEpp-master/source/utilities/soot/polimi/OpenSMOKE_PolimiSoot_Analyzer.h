...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		enum SootPlanckCoefficient { SOOT_PLANCK_COEFFICIENT_NONE, SOOT_PLANCK_COEFFICIENT_SMOOKE, SOOT_PLANCK_COEFFICIENT_KENT, SOOT_PLANCK_COEFFICIENT_SAZHIN, SOOT_PLANCK_COEFFICIENT_HUBBARD };
