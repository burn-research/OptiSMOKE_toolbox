...
namespace OpenSMOKE
{
	class Grammar_PerfectlyStirredReactor_Options : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
		...
		virtual void DefineRules()
		{
			...
			AddKeyWord( OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@VerboseReactionRatesFile", 
																OpenSMOKE::SINGLE_BOOL, 
																"If set false means that output ASCII Reaction rates file will not be written", 
																false) );
	...
	PerfectlyStirredReactor_Options::PerfectlyStirredReactor_Options()
	{
		verbose_output_ = true;
		verbose_video_ = true;
		verbose_ascii_file_ = true;
		verbose_reactionrates_file_ = false;
	...
	void PerfectlyStirredReactor_Options::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary)
	{
		Grammar_PerfectlyStirredReactor_Options grammar;
		...
		if (dictionary.CheckOption("@VerboseReactionRatesFile") == true)
			dictionary.ReadBool("@VerboseReactionRatesFile", verbose_reactionrates_file_);
		...
		if (verbose_reactionrates_file_ == true)
			verbose_output_ = true;
