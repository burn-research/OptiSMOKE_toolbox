...
namespace OpenSMOKE
{
	...
	*/
	...
	class BatchReactor_Isothermal_ConstantVolume : public virtual BatchReactor
	{
	...
	public:
		...
		*/
		BatchReactor_Isothermal_ConstantVolume(	OpenSMOKE::ThermodynamicsMap_CHEMKIN& thermodynamicsMap, 
