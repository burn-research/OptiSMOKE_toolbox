...
#ifndef OpenSMOKE_PlugFlowReactor_Profile_H
#define	OpenSMOKE_PlugFlowReactor_Profile_H
...
namespace OpenSMOKE
{
	...
	*/
	...
	class PlugFlowReactor_Profile
	{
	public:

		PlugFlowReactor_Profile(OpenSMOKE::OpenSMOKEVectorDouble& x, OpenSMOKE::OpenSMOKEVectorDouble& y, const std::string x_variable);
...
#include "PlugFlowReactor_Profile.hpp"

#endif	/* OpenSMOKE_PlugFlowReactor_Profile_H */
