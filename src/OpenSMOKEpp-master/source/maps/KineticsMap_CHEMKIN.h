	...
	*/
	...
	public:
		...
		*/
		...
		/**
		*@brief Return the activation energy of a single reaction [K]
		*@param j index of reaction (starting from zero)
		*/
		...
		*/
		...
		/* HERE WE WANT TO MAKE PUBLIC THE OBJECT RELATED TO EXTENDED PLOG ciao */ 
		ExtendedPressureLogarithmicRateExpression& extendedpressurelog_reactions(const unsigned int j) {return extendedpressurelog_reactions_[j];}
		unsigned int number_of_extendedpressurelog_reactions() const { return number_of_extendedpressurelog_reactions_; }
		const std::vector<unsigned int>& indices_of_extendedpressurelog_reactions() const { return indices_of_extendedpressurelog_reactions__; }

		/* HERE WE WANT TO MAKE PUBLIC THE OBJECT RELATED TO EXTENDED PLOG */
		Optimization_EPLE& extendedplogopt_reactions(const unsigned int j) {return extendedplogopt_reactions_[j];}
		unsigned int number_of_extendedplogopt_reactions() const { return number_of_extendedplogopt_reactions_; }
		const std::vector<unsigned int>& indices_of_extendedpressurelogopt_reactions() const { return indices_of_extendedpressurelogopt_reactions__; }

		/* HERE WE WANT TO MAKE PUBLIC THE OBJECT RELATED TO NORMAL PLOG */
		PressureLogarithmicRateExpression& pressurelog_reactions(const unsigned int j) const {return pressurelog_reactions_[j];}
		unsigned int number_of_pressurelog_reactions() const { return number_of_pressurelog_reactions_; }
		const std::vector<unsigned int>& indices_of_pressurelog_reactions() const { return indices_of_pressurelog_reactions__; }
	...
	private:
		...
		*/
		...
		/**
		*@brief Calculates the kinetic constants for extended pressure log reactions for optimization
		*/
		void ExtendedPressureLogReactionsForOptimization(const double cTot, const double* c);
	...
	private:
		...
		// AB //
		std::vector<unsigned int> indices_of_extendedpressurelogopt_reactions__;	//!< indices of extended pressurelog (EXTPLOG) reactions for optimization
		// AB //
		...
		// AB //
		unsigned int number_of_extendedplogopt_reactions_; 
		// AB //
		...
		// AB //
		Optimization_EPLE* extendedplogopt_reactions_;
		// AB //
