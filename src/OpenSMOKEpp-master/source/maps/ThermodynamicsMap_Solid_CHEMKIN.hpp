...
{ 
	...
	inline double ThermodynamicsMap_Solid_CHEMKIN::MolecularWeight_From_MoleFractions(const double* x)
	{
		ErrorMessage("ThermodynamicsMap_Solid_CHEMKIN::MolecularWeight_From_MoleFractions", "Function not available for surface thermodynamics!");
		return 0;
	}

	inline double ThermodynamicsMap_Solid_CHEMKIN::MolecularWeight_From_MassFractions(const double* y)
	{
		ErrorMessage("ThermodynamicsMap_Solid_CHEMKIN::MolecularWeight_From_MassFractions", "Function not available for surface thermodynamics!");
		return 0;
	}

	inline void ThermodynamicsMap_Solid_CHEMKIN::MassFractions_From_MoleFractions(double* y, double& MW, const double* x)
	{
		ErrorMessage("ThermodynamicsMap_Solid_CHEMKIN::MassFractions_From_MoleFractions", "Function not available for surface thermodynamics!");
	}

	inline void ThermodynamicsMap_Solid_CHEMKIN::MoleFractions_From_MassFractions(double* x, double& MW, const double* y)
	{
		ErrorMessage("ThermodynamicsMap_Solid_CHEMKIN::MoleFractions_From_MassFractions", "Function not available for surface thermodynamics!");
	}

	inline double ThermodynamicsMap_Solid_CHEMKIN::SolidMolecularWeight_From_SolidMoleFractions(const double* x)
	{	
        double MW = 0.;
	...
	inline double ThermodynamicsMap_Solid_CHEMKIN::SolidMolecularWeight_From_SolidMassFractions(const double* y)
	{
        double  MW = 0.;
        for (unsigned int j=1;j<=number_of_solid_species_;j++)
	...
	inline void ThermodynamicsMap_Solid_CHEMKIN::SolidMassFractions_From_SolidMoleFractions(double* y, double& MW, const double* x)
	{
        MW = 0.;
        for (unsigned int j=1;j<=number_of_solid_species_;j++)
            MW += x[j] * this->MW__[number_of_gas_species_ + j-1];
	...
	inline void ThermodynamicsMap_Solid_CHEMKIN::SolidMoleFractions_From_SolidMassFractions(double* x, double& MW, const double* y)
	{
        MW = 0.;
        for (unsigned int j=1;j<=number_of_solid_species_;j++)
            MW += y[j] / this->MW__[number_of_gas_species_ + j-1];
	...
	double ThermodynamicsMap_Solid_CHEMKIN::cpMolar_Mixture_From_MoleFractions(const double* x)
	{
	...
	double ThermodynamicsMap_Solid_CHEMKIN::hMolar_Mixture_From_MoleFractions(const double* x)
	{
	...
	double ThermodynamicsMap_Solid_CHEMKIN::sMolar_Mixture_From_MoleFractions(const double* x)
	{
	...
	double ThermodynamicsMap_Solid_CHEMKIN::uMolar_Mixture_From_MoleFractions(const double* x)
	{
	...
	double ThermodynamicsMap_Solid_CHEMKIN::gMolar_Mixture_From_MoleFractions(const double* x)
	{
	...
	double ThermodynamicsMap_Solid_CHEMKIN::aMolar_Mixture_From_MoleFractions(const double* x)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::cpMolar_Species(double* cp_species)
	{
		cp_over_R();
		Prod(this->nspecies_, PhysicalConstants::R_J_kmol, species_cp_over_R__.data(), cp_species);
	}

	void ThermodynamicsMap_Solid_CHEMKIN::cpMolar_SolidSpecies(double* cp_solidspecies)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::hMolar_Species(double* h_species)
	{
		h_over_RT();
		Prod(this->nspecies_, PhysicalConstants::R_J_kmol*this->T_, species_h_over_RT__.data(), h_species);
	}
        
	void ThermodynamicsMap_Solid_CHEMKIN::hMolar_SolidSpecies(double* h_solidspecies)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::sMolar_Species(double* s_species)
	{
		s_over_R();
		Prod(this->nspecies_, PhysicalConstants::R_J_kmol, species_s_over_R__.data(), s_species);
	}
        
	void ThermodynamicsMap_Solid_CHEMKIN::sMolar_SolidSpecies(double* s_solidspecies)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::sMolar_Species_MixtureAveraged_From_MoleFractions(double* s_species, const double* x)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::uMolar_Species(double* u_species)
	{
		h_over_RT();
	...
	void ThermodynamicsMap_Solid_CHEMKIN::uMolar_SolidSpecies(double* u_solidspecies)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::gMolar_Species(double* g_species)
	{
		h_over_RT();
		s_over_R();
	...
	void ThermodynamicsMap_Solid_CHEMKIN::gMolar_SolidSpecies(double* g_solidspecies)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::gMolar_Species_MixtureAveraged_From_MoleFractions(double* g_species, const double* x)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::aMolar_Species(double* a_species)
	{
		h_over_RT();
		s_over_R();
	...
	void ThermodynamicsMap_Solid_CHEMKIN::aMolar_SolidSpecies(double* a_solidspecies)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::aMolar_Species_MixtureAveraged_From_MoleFractions(double* a_species, const double* x)
	{
	...
	void ThermodynamicsMap_Solid_CHEMKIN::DerivativesOfConcentrationsWithRespectToMassFractions(const double cTot, const double MW, const double* omega, Eigen::MatrixXd* dc_over_omega)
	{
