...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*/
		void FormationRates(double* Rgas, double* Rsolid);
		...
		*/
		double HeatRelease(const double* Rgas, const double* RSolid);
		...
		*/
		void ReactionRates(const double* cGas, const double* cSolid);
