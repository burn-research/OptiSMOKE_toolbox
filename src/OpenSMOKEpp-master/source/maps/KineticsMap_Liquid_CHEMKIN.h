...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*/
		KineticsMap_Liquid_CHEMKIN(ThermodynamicsMap_Liquid_CHEMKIN& thermo, rapidxml::xml_document<>& doc, const unsigned int target);
		...
		*/
		KineticsMap_Liquid_CHEMKIN(ThermodynamicsMap_Liquid_CHEMKIN& thermo, rapidxml::xml_document<>& doc, const std::string target);
