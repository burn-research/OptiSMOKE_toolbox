...
#ifndef OPENSMOKEPP_GRAMMAR_GASMIXTURE_H
#define OPENSMOKEPP_GRAMMAR_GASMIXTURE_H
...
class Grammar_GasMixture : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
{
	protected:
	...
	virtual void DefineRules()
	{
		AddKeyWord(	OpenSMOKE::OpenSMOKE_DictionaryKeyWord
						(	"@Fugacity", OpenSMOKE::SINGLE_STRING,
							"Fugacity rule for gaseous phase: 1=Ideal | 2=Peng-Robinson", false	)	);
	}
};

#endif	// OPENSMOKEPP_GRAMMAR_GASMIXTURE_H
