...
/**
 \class FugacityLPengRobinsonDirect_mix
 \brief Class to calculate liquid fugacity via Peng-Robinson EoS (Direct approach)
 
 Class to calculate liquid fugacity via Peng-Robinson EoS (Direct approach)
 */

#ifndef OPENSMOKEPP_FUGACITYL_PENGROBINSONDIRECT_MIX_H
#define OPENSMOKEPP_FUGACITYL_PENGROBINSONDIRECT_MIX_H

class FugacityLPengRobinsonDirect_mix : public FugacityModel_mix
{
	public:

		FugacityLPengRobinsonDirect_mix(	const unsigned int NS, 
											const std::vector<double>& Tc, const std::vector<double>& Pc,
											const std::vector<double>& omega, const std::vector<double>& MW);
		
		~FugacityLPengRobinsonDirect_mix();
...
#include "fugacityLPengRobinsonDirect_mix.hpp"

#endif	// OPENSMOKEPP_FUGACITYL_PENGROBINSONDIRECT_MIX_H
