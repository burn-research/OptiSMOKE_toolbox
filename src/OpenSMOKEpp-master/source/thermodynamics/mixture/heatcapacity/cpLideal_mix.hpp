...
cpLIdealmix::cpLIdealmix(const unsigned int NS, const std::vector<double>& MW) :
MW_(MW),
CapacityModel_mix(NS) 
{
}

double cpLIdealmix::cp(const std::vector<double>& cp, const std::vector<double>& x)
{
