	...
	protected:
		...
		virtual void DefineRules()
		{
            ...
            AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@MutationRate",
                ...
                generated by crossover (if crossover occurs) and for individuals from the existing population. It is the fraction of \
                trial points that are mutated in a given iteration and therefore must be specified to be between 0 and 1.",
                false,"none","none","none"));

            AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@CrossoverType",
                OpenSMOKE::SINGLE_STRING,
                "The crossover_type controls what approach is employed for combining parent genetic information to create offspring. \
                The SCOLIB EA method supports three forms of crossover, two_point, blend, and uniform, which generate a new individual \
                through combinations of two parent individuals.",
                false));

            AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@CrossoverRate",
                OpenSMOKE::SINGLE_STRING,
                "The crossover_type controls what approach is employed for combining parent genetic information to create offspring, \
                and the crossover_rate specifies the probability of a crossover operation being performed to generate a new offspring.",
                false,"none","none","none"));

            AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@ReplacementType",
                OpenSMOKE::SINGLE_STRING,
                "The replacement_type controls how current populations and newly generated individuals are combined to create a new population. \
                Each of the replacement_type selections accepts an associated integer value. (random | chc | elitist)",
                false));
            ...
            AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@GlobalBalanceParameter",
                ...
                Intuitively, this forces large subregions to be subdivided before the smallest subregions are refined.",
                false));
