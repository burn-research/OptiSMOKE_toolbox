...
void options_optimization_target::SetupFromDictionary(
  ...
  if (dictionary_manager(dictionary_name).CheckOption("@ListOfTarget_E_over_R_inf"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTarget_E_over_R_inf", list_of_target_E_over_R_inf_);

  numberOfParameters_ += list_of_target_E_over_R_inf_.size();

  if (dictionary_manager(dictionary_name)
          .CheckOption("@ListOfTarget_ThirdBody_Reactions"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTarget_ThirdBody_Reactions",
  ...
  // Classic PLOG - which
  if (dictionary_manager(dictionary_name)
          .CheckOption("@ListOfTarget_classic_PLOG_Reactions"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTarget_classic_PLOG_Reactions",
                    list_of_target_classic_plog_reactions_);

  numberOfParameters_ += list_of_target_classic_plog_reactions_.size() * 3;

  if (dictionary_manager(dictionary_name)
          .CheckOption("@ListOfUncertaintyFactors_classic_PLOG"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfUncertaintyFactors_classic_PLOG",
  ...
  if (dictionary_manager(dictionary_name).CheckOption("@ListOfTarget_RPBMR_Reactions"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTarget_RPBMR_Reactions", list_of_target_rpbmr_reactions_);

  if (dictionary_manager(dictionary_name).CheckOption("@ListOfTarget_BathGases_RPBMR"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTarget_BathGases_RPBMR", list_of_target_rpbmr_bathgases_);

  if (dictionary_manager(dictionary_name).CheckOption("@ListOfUncertaintyFactors_RPBMR"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfUncertaintyFactors_RPBMR",
                    list_of_uncertainty_factors_rpbmr_);
  ...
  if (dictionary_manager(dictionary_name).CheckOption("@ListOfTarget_ThirdBody_Species"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTarget_ThirdBody_Species",
  ...
  if (dictionary_manager(dictionary_name).CheckOption("@ListOfTargetUncertaintyFactors"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTargetUncertaintyFactors",
  ...
  if (dictionary_manager(dictionary_name).CheckOption("@ListOfUncertaintyFactors"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfUncertaintyFactors", list_of_uncertainty_factors_);

  // List of target inf reactions for uncertainty factors
  if (dictionary_manager(dictionary_name)
          .CheckOption("@ListOfTargetUncertaintyFactors_inf"))
    dictionary_manager(dictionary_name)
        .ReadOption("@ListOfTargetUncertaintyFactors_inf",
