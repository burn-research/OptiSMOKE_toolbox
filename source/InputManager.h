...
namespace OptiSMOKE{
  ...
  class InputManager
  {
    public:
      ...
      inline const OptiSMOKE::DataManager& data_manager() const {return data_manager_;};

      inline const bool& iXml() const {return iXml_;};
      inline const bool& isMaster() const {return isMaster_;};
      inline const int& rank() const {return rank_;};
      inline const int& nprocs() const {return nprocs_;};
      ...
      inline const std::vector<int>& n_local_sim() const {return n_local_sim_;};
      inline const std::vector<int>& local_index() const {return local_index_;};
      inline const std::vector<int>& global_index() const {return global_index_;};
      inline const std::vector<int>& file_index() const {return file_index_;};
      inline const std::vector<fs::path>& flatten_inputs() const {return flatten_inputs_;};
    ...
    private:
      ...
      std::vector<int> n_local_sim_;
      std::vector<int> offset_;
      std::vector<int> local_index_;
      std::vector<int> global_index_;
      std::vector<int> file_index_;
      std::vector<fs::path> flatten_inputs_;
  };
} // namespace OptiSMOKE
